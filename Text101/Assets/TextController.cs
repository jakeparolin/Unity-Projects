...
public class TextController : MonoBehaviour
{
    ...
    void state_lock_0()
    {
        text.text = "This is one of those button locks. You have no idea what " +
                    ...
                    "dirty fingerprints were, maybe that would help. \n\n" +
                    "Press: \n R to Return to roaming your cell";
        if (Input.GetKeyDown(KeyCode.R)) { myState = States.cell; }
    }
    ...
    void state_lock_1()
    {
        text.text = "You carefully put the mirror through the bars, and turn " +
                    ...
                    "fingerprints around the buttons. You press the dirty " +
                    "buttons, and hear a click. \n\n" +
    ...
    void state_cell_mirror()
    {
        text.text = "You are still in your cell, and you STILL want to " +
                    ...
                    "mark where the mirror was, and that pesky door is " +
                    "still there, and firmly locked! \n\n" +
                    "Press: \n S to view the Sheets \n L to view the Lock";
